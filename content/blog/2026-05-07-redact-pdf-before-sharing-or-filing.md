...
1. Source file selected intentionally.
2. Sensitive fields identified completely.
3. Redaction applied only where needed.
4. Redacted copy reviewed page by page.
