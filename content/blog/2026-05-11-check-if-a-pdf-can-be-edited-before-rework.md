...
5. Move into the chosen workflow only after the check is clear.
6. Keep the file associated with one rework branch instead of opening several experiments.
...
1. Exact source file selected.
2. Editability checked first.
3. Restriction status confirmed.
4. Rework branch chosen intentionally.
