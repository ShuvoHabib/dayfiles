...
<figure>
  ...
  <figcaption>Use this Dayfiles view as the operational starting point for PDF-to-DOCX-to-PDF revision work.</figcaption>
</figure>
...
- one untouched source PDF
- one editable DOCX working copy
- one rebuilt final PDF
- one review pass that compares wording and layout
