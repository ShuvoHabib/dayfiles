...
1. collect approved forms into one packet folder
2. fill and review the packet before signatures begin
3. sign only the approved copy
4. archive the signed final packet separately from editable working files
