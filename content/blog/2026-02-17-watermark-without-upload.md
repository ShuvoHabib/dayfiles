...
- mark a file as draft before internal review
- label a confidential packet before sharing
- add a visible ownership cue to a document that may circulate
...
<figure>
  ...
  <figcaption>Use the live PDF Dayfiles route as the visual starting point for add a watermark to a PDF.</figcaption>
</figure>
...
- decide whether the watermark is for status or control
- choose placement that will not block signatures or dense text
- confirm whether the destination accepts visible marking
...
- covering signatures or table text
- using a watermark that is too faint to be useful
- forgetting which copy is the clean original
