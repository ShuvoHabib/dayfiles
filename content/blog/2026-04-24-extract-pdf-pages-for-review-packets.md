...
7. Keep the full source packet separate from the extracted review file.
...
1. Source PDF confirmed.
2. Exact range selected intentionally.
3. Output file named by purpose.
4. First and last pages checked.
