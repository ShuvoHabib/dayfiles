...
<figure>
  <img src="/blog/images/pdf-e-sign-pdf-live.png" alt="Live PDF Dayfiles e-sign page showing the browser-based signing route and upload-first layout" loading="lazy" />
  <figcaption>Use the live PDF Dayfiles route as the visual starting point for e-sign a PDF in the browser.</figcaption>
</figure>
