...
<figure>
  ...
  <figcaption>Use the live PDF Dayfiles route as the visual starting point for reorder PDF pages.</figcaption>
</figure>
...
1. Start from the PDF Toolkit hub and open the organize route.
2. Load the file and map the intended sequence before dragging pages around.
3. Move pages into the final order and remove anything that does not belong in the packet.
4. Export one clean reordered copy.
5. Review the output like a recipient would, from page one to the end.
...
1. The packet tells the story in the intended order.
2. No page disappeared during reordering.
3. Page numbering or references still make sense after export.
