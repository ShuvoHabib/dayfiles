...
<figure>
  <img src="/blog/images/images-convert-to-jpg-live.png" alt="Live Images Dayfiles convert-to-jpg page showing the browser-based JPG conversion workflow" loading="lazy" />
  <figcaption>Use the live Images Dayfiles route as the visual checkpoint for convert mixed image files to JPG.</figcaption>
</figure>
