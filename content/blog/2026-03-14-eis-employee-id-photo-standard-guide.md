...
## How should the ID photo approvals checklist be used under deadline?
...
## Which issues should stop the ID photo approvals workflow immediately?
...
## How should the final owner document the ID photo approvals result?
...
## What should the next person never have to guess about ID photo approvals?
...
## What does a strong ID photo approvals final pass feel like?
...
## Why this ID photo approvals checklist is worth keeping
