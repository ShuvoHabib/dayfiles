...
<figure>
  <img src="/blog/images/images-resize-image-live.png" alt="Live Images Dayfiles resize-image page showing the browser-based resize workflow" loading="lazy" />
  <figcaption>Use the live Images Dayfiles route as the visual checkpoint for resize image batches for listings.</figcaption>
</figure>
