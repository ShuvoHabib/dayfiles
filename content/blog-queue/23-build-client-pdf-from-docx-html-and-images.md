...
1. Define the final packet order before conversion begins.
2. Convert each source type into its own approved PDF component.
3. Review every component PDF before merge.
